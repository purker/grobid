...
public class DocumentSource {
	...
	public DocumentSource(File pdfFile) {
		this(pdfFile, -1, -1);
	}
	 ...
	 */
	public DocumentSource(File pdfFile, int startPage, int endPage) {
		this(pdfFile, startPage, endPage, false, true);
	}
	...
	public DocumentSource(File pdfFile, int startPage, int endPage,
		...
		this.cleanupXml = true;

		try {
			this.xmlFile = this.pdf2xml(null, false, startPage, endPage, pdfFile, GrobidProperties.getTempPath(),
					withImages, withAnnotations);
		} catch (Exception e) {
