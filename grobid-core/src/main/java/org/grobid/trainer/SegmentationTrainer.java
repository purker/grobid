...
public class SegmentationTrainer extends AbstractTrainer {
	...
	public int addFeaturesSegmentation(String sourceTEIPathLabel,
		...
		try {
			...
			for (File tf : refFiles) {
				...
				List<String> labeled = SegmentationTrainer.getLabeledTokensFromTeiFile(spf, tf);
	...
	public static List<String> getLabeledTokensFromTeiFile(SAXParserFactory spf, File teiFile)
			throws ParserConfigurationException, SAXException, IOException {
		TEISegmentationSaxParser parser = new TEISegmentationSaxParser();
